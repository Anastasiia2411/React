...
export function ProductElement({ product, handleButtonClick, onBuyButtonClick, onProductDeleteButtonClick, isLiked, buttonText, onAddToLikedButtonClick, type }) {
    ...
    return (
        <Product>
            <img
                src={product.photo || product.product.photo}
                alt="jacket"
                height="350"
            />
            <div onClick={() => {
            ...
            <ProductList>
                ...
                <li>
                    article:{product.article || product.product.article}
                </li>
                <li>
